...
class DealDocuments:
    ...
    def convert_doc_to_docx(filename: str):
        ...
        # 用相对路径会有问题
        absolute_read_path = 'D:\\Documents\\卷\\大二上\\数据科学基础\\大作业\\data' + filename
        absolute_write_path = 'D:\\Documents\\卷\\大二上\\数据科学基础\\大作业\\data_docx' + filename + 'x'
